...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.CategoryViewHolder> {
    ...
    class CategoryViewHolder extends RecyclerView.ViewHolder {
        ...
        private int getCategoryTintColor(int categoryId) {
            switch (categoryId) {
                case 2: return ContextCompat.getColor(context, R.color.green_500);
                case 3: return ContextCompat.getColor(context, R.color.orange_500);
                case 4: return ContextCompat.getColor(context, R.color.purple_500);
                default: return ContextCompat.getColor(context, R.color.blue_500);
            }
        }
    }
}